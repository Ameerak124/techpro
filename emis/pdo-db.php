...
$servernamemis = "krkdbmed.c9g5xuzwcfdr.ap-south-1.rds.amazonaws.com";
$usernamemis = "root";
$passwordmis = "powerpopgirls1@";
$databasemis = "mhcpanel_mis";

$baseurl = "http://alb-app-1655237078.ap-south-1.elb.amazonaws.com/mobile-api/emis/";
try{
    $medicovermis = new PDO("mysql:host=" . $servernamemis . ";dbname=" . $databasemis.";charset=utf8", $usernamemis, $passwordmis);
	$medicovermis->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
