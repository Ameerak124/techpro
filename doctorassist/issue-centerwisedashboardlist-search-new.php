...
if($result['role']=='Center Head'){
	...
	$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, doctor_raise_ticket.`type`,doctor_raise_ticket.user_name, doctor_raise_ticket.`ticket_id`, doctor_raise_ticket.`category`, doctor_raise_ticket.`issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon , CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,realstatus,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center  WHERE `realstatus` IN ('Pending at Medical Head') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
	$revenue_list->bindParam(':branch', $branch, PDO::PARAM_STR);
	...
	$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, doctor_raise_ticket.`type`,doctor_raise_ticket.user_name, doctor_raise_ticket.`ticket_id`, doctor_raise_ticket.`category`, doctor_raise_ticket.`issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon , CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,realstatus,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center  WHERE `realstatus` in ('Pending at Center Head','Pending by Sub Center head','Pending at Medical Head') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
	$revenue_list->bindParam(':branch', $branch, PDO::PARAM_STR);
	...
	$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, `type`, doctor_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon , CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,realstatus ,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center WHERE `realstatus`in ('Pending by Director Operations') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
	$revenue_list->bindParam(':branch', $branch, PDO::PARAM_STR);
	...
	$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, `type`, doctor_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon ,CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,`realstatus` F,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center WHERE `realstatus`IN ('Pending by ED') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
	$revenue_list->bindParam(':branch', $branch, PDO::PARAM_STR);
  ...
  /*       $displaybutton ="SELECT  if(`assign`='1','Assign','No') AS assign_button, if(`escalate`='1','Escalate','No') AS `escalate_button`,if(`reject`='1','Reject','No') AS`reject`, if(`resolve`='1','Resolve','No') AS `resolve`,if(`inprocessing`='1','Inprocessing','No') as inprocessing,if(`assign`='1','#E7FDEA','No') AS bgassign, if(`escalate`='1','#E5E9FF','No') AS `bgescalate`,if(`reject`='1','#FFD9D9','No') AS`bgreject`, if(`resolve`='1','#BBF4DB','No') AS `bgresolve`,if(`inprocessing`='1','#E9bbF4','No') as bgprocessing,if(`assign`='1','#49B888','No') AS textassign, if(`escalate`='1','#369DB3','No') AS `textescalate`,if(`reject`='1','#FD1F0F','No') AS`textreject`, if(`resolve`='1','#407529','No') AS `textresolve`,if(`inprocessing`='1','#5E2975','No') as textprocessing FROM `issue_level_designations` WHERE CL ='ED' and FIND_IN_SET(:role,`CL`)<>0 LIMIT 1";
	...
	$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, `type`, doctor_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon , CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,`realstatus` ,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center WHERE (`realstatus` LIKE  '%Resolve%' or `realstatus` LIKE  '%Reject%') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
	$revenue_list->bindParam(':branch', $branch, PDO::PARAM_STR);
...
if($result['role']=='Center Head'){
		...
		$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, doctor_raise_ticket.`type`,doctor_raise_ticket.user_name, doctor_raise_ticket.`ticket_id`, doctor_raise_ticket.`category`, doctor_raise_ticket.`issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon , CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,realstatus,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center  WHERE `realstatus` IN (:status) and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and doctor_raise_ticket.category_type=:category and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	...
	$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, doctor_raise_ticket.`type`,doctor_raise_ticket.user_name, doctor_raise_ticket.`ticket_id`, doctor_raise_ticket.`category`, doctor_raise_ticket.`issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon ,CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %H:%i:%s') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,realstatus,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center  WHERE `realstatus` IN ('Pending at Medical Head') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and doctor_raise_ticket.category_type=:category and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':category', $category, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
	...
	$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, doctor_raise_ticket.`type`,doctor_raise_ticket.user_name, doctor_raise_ticket.`ticket_id`, doctor_raise_ticket.`category`, doctor_raise_ticket.`issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon , CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,realstatus,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center  WHERE `realstatus` in ('Pending at Center Head','Pending by Sub Center head','Pending at Medical Head') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and doctor_raise_ticket.category_type=:category and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':category', $category, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
    ...
    $rows = $stmt12->fetch();
		...
		$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, `type`,doctor_raise_ticket.user_name, `ticket_id`, `category`, `issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon , CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,realstatus ,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center  WHERE `realstatus` IN ('Pending by Corporate Head') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and doctor_raise_ticket.category_type=:category and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':category', $category, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
	...
	$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, `type`, doctor_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon , CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,realstatus ,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center WHERE `realstatus`in ('Pending by Director Operations') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and doctor_raise_ticket.category_type=:category and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':category', $category, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
	...
	$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, `type`, doctor_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon , CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,`realstatus` F,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center WHERE `realstatus`IN ('Pending by ED') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and doctor_raise_ticket.category_type=:category and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':category', $category, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
  ...
  /*       $displaybutton ="SELECT  if(`assign`='1','Assign','No') AS assign_button, if(`escalate`='1','Escalate','No') AS `escalate_button`,if(`reject`='1','Reject','No') AS`reject`, if(`resolve`='1','Resolve','No') AS `resolve`,if(`inprocessing`='1','Inprocessing','No') as inprocessing,if(`assign`='1','#E7FDEA','No') AS bgassign, if(`escalate`='1','#E5E9FF','No') AS `bgescalate`,if(`reject`='1','#FFD9D9','No') AS`bgreject`, if(`resolve`='1','#BBF4DB','No') AS `bgresolve`,if(`inprocessing`='1','#E9bbF4','No') as bgprocessing,if(`assign`='1','#49B888','No') AS textassign, if(`escalate`='1','#369DB3','No') AS `textescalate`,if(`reject`='1','#FD1F0F','No') AS`textreject`, if(`resolve`='1','#407529','No') AS `textresolve`,if(`inprocessing`='1','#5E2975','No') as textprocessing FROM `issue_level_designations` WHERE CL ='ED' and FIND_IN_SET(:role,`CL`)<>0 LIMIT 1";
	...
	$revenue_list = $pdoread -> prepare("SELECT doctor_raise_ticket.`sno`, `type`, doctor_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(doctor_raise_ticket.`issues`='Any other Suggestions',doctor_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when doctor_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') else concat(:baseurl,'appicons/solve.png') end  as icon , CASE WHEN doctor_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN doctor_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color,doctor_raise_ticket.`created_by`, date_format(doctor_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , doctor_raise_ticket.`modified_by`, doctor_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,doctor_raise_ticket.status ,assigned_person,`realstatus` ,doctor_raise_ticket.branch,branch_master.display_name as branchname,IF(doctor_raise_ticket.category_type='','',doctor_raise_ticket.category_type) AS category_type,,if(doctor_raise_ticket.category_type='Urgent and Important','#db3623',if(doctor_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(doctor_raise_ticket.category_type='Not Urgent but Important','#d68233',if(doctor_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `doctor_raise_ticket` inner join branch_master on doctor_raise_ticket.branch=branch_master.cost_center WHERE (`realstatus` LIKE  '%Resolve%' or `realstatus` LIKE  '%Reject%') and doctor_raise_ticket.`branch`=:branch and date(doctor_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and doctor_raise_ticket.category_type=:category and (ticket_id like :searchterm||user_name like :searchterm) ORDER BY  doctor_raise_ticket.created_on DESC");
		$revenue_list->bindParam(':fdate', $fdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':tdate', $tdate, PDO::PARAM_STR);
	$revenue_list->bindParam(':category', $category, PDO::PARAM_STR);
	//$revenue_list->bindParam(':branch', $result['cost_center'], PDO::PARAM_STR);
