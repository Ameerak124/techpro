...
$percheck ="SELECT `menu`,`submenu` As name,`dashboardtitle` As title,`packagename` As packagename,`ioscontrollers` as webcontroller,`classname`, `classtype`,CONCAT(:baseurl,'appicons/',`d-icons`) AS icon,storyboardname  FROM `android_permissions_new` WHERE `sno`=:key AND `source`='Doctor Assist' and status='Active'";
