...
if($check -> rowCount() > 0){
    ...
    $rows = $stmt12->fetch();	
		...
		$revenue_list = $pdo -> prepare("SELECT employee_raise_ticket.`sno`, employee_raise_ticket.`type`,employee_raise_ticket.user_name, employee_raise_ticket.`ticket_id`, employee_raise_ticket.`category`, employee_raise_ticket.`issues`,if(employee_raise_ticket.`issues`='Any other Suggestions',employee_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when employee_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') WHEN employee_raise_ticket.`status` like '%Rejected%' THEN concat(:baseurl,'appicons/rejected.png')  else concat(:baseurl,'appicons/accepted.png') end  as icon , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN employee_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,employee_raise_ticket.`created_by`, date_format(employee_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , employee_raise_ticket.`modified_by`, employee_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,employee_raise_ticket.status ,assigned_person,realstatus,employee_raise_ticket.branch,branch_master.display_name as branchname,IF(employee_raise_ticket.category_type='','',employee_raise_ticket.category_type) AS category_type,if(employee_raise_ticket.category_type='Urgent and Important','#db3623',if(employee_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(employee_raise_ticket.category_type='Not Urgent but Important','#d68233',if(employee_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `employee_raise_ticket` inner join branch_master on employee_raise_ticket.branch=branch_master.cost_center  WHERE `realstatus`in ('Pending at Unit HR','Inprocessing by Unit HR') and employee_raise_ticket.`branch`=:branch and date(employee_raise_ticket.`created_on`) BETWEEN :fdate and :tdate ORDER BY  employee_raise_ticket.created_on DESC");
	...
	//$revenue_list->bindValue(':searchterm', "%{$searchterm}%", PDO::PARAM_STR);
   	$revenue_list -> execute();
	    ...
	    $displaybutton ="SELECT  if(`assign`='1','Assign','No') AS assign_button, if(`escalate`='1','Escalate','No') AS `escalate_button`,if(`reject`='1','Reject','No') AS`reject`, if(`resolve`='1','Resolve','No') AS `resolve`,if(`inprocessing`='1','Inprocessing','No') as inprocessing,if(`assign`='1','#E7FDEA','No') AS bgassign, if(`escalate`='1','#E5E9FF','No') AS `bgescalate`,if(`reject`='1','#FFD9D9','No') AS`bgreject`, if(`resolve`='1','#BBF4DB','No') AS `bgresolve`,if(`inprocessing`='1','#E9bbF4','No') as bgprocessing,if(`assign`='1','#49B888','No') AS textassign, if(`escalate`='1','#369DB3','No') AS `textescalate`,if(`reject`='1','#FD1F0F','No') AS`textreject`, if(`resolve`='1','#407529','No') AS `textresolve`,if(`inprocessing`='1','#5E2975','No') as textprocessing FROM `employee_level_designations` inner join user_logins on user_logins.role= employee_level_designations.CL WHERE CL ='Regional HR'  AND FIND_IN_SET(:branch,user_logins.branch)<>0  AND user_logins.userid=:empid and FIND_IN_SET(:role,`CL`)<>0 LIMIT 1";
	$stmt12 = $pdo->prepare($displaybutton);
	$stmt12 -> bindParam(":role", $result['role'], PDO::PARAM_STR);
	$stmt12 -> bindParam(":branch", $branch, PDO::PARAM_STR);
	$stmt12 -> bindParam(":empid", $result['userid'], PDO::PARAM_STR);
	...
	$revenue_list -> execute();
		...
		$displaybutton ="SELECT  if(`assign`='1','Assign','No') AS assign_button, if(`escalate`='1','Escalate','No') AS `escalate_button`,if(`reject`='1','Reject','No') AS`reject`, if(`resolve`='1','Resolve','No') AS `resolve`,if(`inprocessing`='1','Inprocessing','No') as inprocessing,if(`assign`='1','#E7FDEA','No') AS bgassign, if(`escalate`='1','#E5E9FF','No') AS `bgescalate`,if(`reject`='1','#FFD9D9','No') AS`bgreject`, if(`resolve`='1','#BBF4DB','No') AS `bgresolve`,if(`inprocessing`='1','#E9bbF4','No') as bgprocessing,if(`assign`='1','#49B888','No') AS textassign, if(`escalate`='1','#369DB3','No') AS `textescalate`,if(`reject`='1','#FD1F0F','No') AS`textreject`, if(`resolve`='1','#407529','No') AS `textresolve`,if(`inprocessing`='1','#5E2975','No') as textprocessing FROM `employee_level_designations` inner join user_logins on user_logins.role= employee_level_designations.CL WHERE CL ='Head HR'  AND user_logins.userid=:empid and FIND_IN_SET(:role,`CL`)<>0 LIMIT 1";
	$stmt12 = $pdo->prepare($displaybutton);
	$stmt12 -> bindParam(":role", $result['role'], PDO::PARAM_STR);
	//$stmt12 -> bindParam(":branch", $branch, PDO::PARAM_STR);
	$stmt12 -> bindParam(":empid", $result['userid'], PDO::PARAM_STR);
	...
	$revenue_list = $pdo -> prepare("SELECT employee_raise_ticket.`sno`, `type`, employee_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(employee_raise_ticket.`issues`='Any other Suggestions',employee_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`,  case when employee_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') WHEN employee_raise_ticket.`status` like '%Rejected%' THEN concat(:baseurl,'appicons/rejected.png')  else concat(:baseurl,'appicons/accepted.png') end  as icon , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN employee_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' ELSE '#419505' END AS color ,employee_raise_ticket.`created_by`, date_format(employee_raise_ticket.`created_on`,'%d-%b-%Y') as created_on , employee_raise_ticket.`modified_by`, employee_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,employee_raise_ticket.status ,assigned_person,realstatus ,employee_raise_ticket.branch,branch_master.display_name as branchname,IF(employee_raise_ticket.category_type='','',employee_raise_ticket.category_type) AS category_type,if(employee_raise_ticket.category_type='Urgent and Important','#db3623',if(employee_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(employee_raise_ticket.category_type='Not Urgent but Important','#d68233',if(employee_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `employee_raise_ticket` inner join branch_master on employee_raise_ticket.branch=branch_master.cost_center WHERE `realstatus`in ('Pending by Head HR','Pending at Head HR','Inprocessing by Head HR') and employee_raise_ticket.`branch`=:branch and date(employee_raise_ticket.`created_on`) BETWEEN :fdate and :tdate ORDER BY  employee_raise_ticket.created_on DESC");
	...
	$revenue_list = $pdo -> prepare("SELECT employee_raise_ticket.`sno`, `type`, employee_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(employee_raise_ticket.`issues`='Any other Suggestions',employee_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`,  case when employee_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') WHEN employee_raise_ticket.`status` like '%Rejected%' THEN concat(:baseurl,'appicons/rejected.png')  else concat(:baseurl,'appicons/accepted.png') end  as icon , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN employee_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color,employee_raise_ticket.`created_by`, date_format(employee_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , employee_raise_ticket.`modified_by`, employee_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,employee_raise_ticket.status ,assigned_person,`realstatus`,employee_raise_ticket.branch,branch_master.display_name as branchname,IF(employee_raise_ticket.category_type='','',employee_raise_ticket.category_type) AS category_type,if(employee_raise_ticket.category_type='Urgent and Important','#db3623',if(employee_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(employee_raise_ticket.category_type='Not Urgent but Important','#d68233',if(employee_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `employee_raise_ticket` inner join branch_master on employee_raise_ticket.branch=branch_master.cost_center WHERE `realstatus`IN ('Pending by ED','Inprocessing by ED','Pending at ED') and employee_raise_ticket.`branch`=:branch and date(employee_raise_ticket.`created_on`) BETWEEN :fdate and :tdate ORDER BY  employee_raise_ticket.created_on DESC");
	...
	$revenue_list = $pdo -> prepare("SELECT employee_raise_ticket.`sno`, `type`, employee_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(employee_raise_ticket.`issues`='Any other Suggestions',employee_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when employee_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') WHEN employee_raise_ticket.`status` like '%Rejected%' THEN concat(:baseurl,'appicons/rejected.png')  else concat(:baseurl,'appicons/accepted.png') end  as icon , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN employee_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,employee_raise_ticket.`created_by`, date_format(employee_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , employee_raise_ticket.`modified_by`, employee_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,employee_raise_ticket.status ,assigned_person,`realstatus` ,employee_raise_ticket.branch,branch_master.display_name as branchname,IF(employee_raise_ticket.category_type='','',employee_raise_ticket.category_type) AS category_type,if(employee_raise_ticket.category_type='Urgent and Important','#db3623',if(employee_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(employee_raise_ticket.category_type='Not Urgent but Important','#d68233',if(employee_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `employee_raise_ticket` inner join branch_master on employee_raise_ticket.branch=branch_master.cost_center WHERE (`realstatus` LIKE  '%Resolve%' or `realstatus` LIKE  '%Reject%') and employee_raise_ticket.`branch`=:branch and date(employee_raise_ticket.`created_on`) BETWEEN :fdate and :tdate ORDER BY  employee_raise_ticket.created_on DESC");
	...
	$revenue_list -> execute();
		...
		$rows = $stmt12->fetch();	
			 ...
			 $revenue_list = $pdo -> prepare("SELECT employee_raise_ticket.`sno`, employee_raise_ticket.`type`,employee_raise_ticket.user_name, employee_raise_ticket.`ticket_id`, employee_raise_ticket.`category`, employee_raise_ticket.`issues`,if(employee_raise_ticket.`issues`='Any other Suggestions',employee_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when employee_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') WHEN employee_raise_ticket.`status` like '%Rejected%' THEN concat(:baseurl,'appicons/rejected.png')  else concat(:baseurl,'appicons/accepted.png') end  as icon , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN employee_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,employee_raise_ticket.`created_by`, date_format(employee_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , employee_raise_ticket.`modified_by`, employee_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,employee_raise_ticket.status ,assigned_person,realstatus,employee_raise_ticket.branch,branch_master.display_name as branchname,IF(employee_raise_ticket.category_type='','',employee_raise_ticket.category_type) AS category_type,if(employee_raise_ticket.category_type='Urgent and Important','#db3623',if(employee_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(employee_raise_ticket.category_type='Not Urgent but Important','#d68233',if(employee_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `employee_raise_ticket` inner join branch_master on employee_raise_ticket.branch=branch_master.cost_center  WHERE `realstatus`in ('Pending at Unit HR','Inprocessing by Unit HR') and employee_raise_ticket.`branch`=:branch and date(employee_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and employee_raise_ticket.category_type=:category  ORDER BY  employee_raise_ticket.created_on DESC");
		...
		$rows = $stmt12->fetch();
			 ...
			 $revenue_list = $pdo -> prepare("SELECT employee_raise_ticket.`sno`, `type`,employee_raise_ticket.user_name, `ticket_id`, `category`, `issues`,if(employee_raise_ticket.`issues`='Any other Suggestions',employee_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`,  case when employee_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') WHEN employee_raise_ticket.`status` like '%Rejected%' THEN concat(:baseurl,'appicons/rejected.png')  else concat(:baseurl,'appicons/accepted.png') end  as icon , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN employee_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,employee_raise_ticket.`created_by`, date_format(employee_raise_ticket.`created_on`,'%d-%b-%Y') as created_on , employee_raise_ticket.`modified_by`, employee_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,employee_raise_ticket.status ,assigned_person,realstatus ,employee_raise_ticket.branch,branch_master.display_name as branchname,IF(employee_raise_ticket.category_type='','',employee_raise_ticket.category_type) AS category_type,if(employee_raise_ticket.category_type='Urgent and Important','#db3623',if(employee_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(employee_raise_ticket.category_type='Not Urgent but Important','#d68233',if(employee_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `employee_raise_ticket` inner join branch_master on employee_raise_ticket.branch=branch_master.cost_center  WHERE `realstatus` IN ('Pending by Regional HR','Inprocessing by Regional HR','Pending at Regional HR') and employee_raise_ticket.`branch`=:branch and date(employee_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and employee_raise_ticket.category_type=:category ORDER BY  employee_raise_ticket.created_on DESC");
		...
		$rows = $stmt12->fetch();
		 ...
		 $revenue_list = $pdo -> prepare("SELECT employee_raise_ticket.`sno`, `type`, employee_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(employee_raise_ticket.`issues`='Any other Suggestions',employee_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`,  case when employee_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') WHEN employee_raise_ticket.`status` like '%Rejected%' THEN concat(:baseurl,'appicons/rejected.png')  else concat(:baseurl,'appicons/accepted.png') end  as icon , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN employee_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' ELSE '#419505' END AS color ,employee_raise_ticket.`created_by`, date_format(employee_raise_ticket.`created_on`,'%d-%b-%Y') as created_on , employee_raise_ticket.`modified_by`, employee_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,employee_raise_ticket.status ,assigned_person,realstatus ,employee_raise_ticket.branch,branch_master.display_name as branchname,IF(employee_raise_ticket.category_type='','',employee_raise_ticket.category_type) AS category_type,if(employee_raise_ticket.category_type='Urgent and Important','#db3623',if(employee_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(employee_raise_ticket.category_type='Not Urgent but Important','#d68233',if(employee_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `employee_raise_ticket` inner join branch_master on employee_raise_ticket.branch=branch_master.cost_center WHERE `realstatus`in ('Pending by Head HR','Pending at Head HR','Inprocessing by Head HR') and employee_raise_ticket.`branch`=:branch and date(employee_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and employee_raise_ticket.category_type=:category ORDER BY  employee_raise_ticket.created_on DESC");
		...
		$rows = $stmt12->fetch();
		 ...
		 $revenue_list = $pdo -> prepare("SELECT employee_raise_ticket.`sno`, `type`, employee_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(employee_raise_ticket.`issues`='Any other Suggestions',employee_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`,  case when employee_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') WHEN employee_raise_ticket.`status` like '%Rejected%' THEN concat(:baseurl,'appicons/rejected.png')  else concat(:baseurl,'appicons/accepted.png') end  as icon , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN employee_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color,employee_raise_ticket.`created_by`, date_format(employee_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , employee_raise_ticket.`modified_by`, employee_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,employee_raise_ticket.status ,assigned_person,`realstatus`,employee_raise_ticket.branch,branch_master.display_name as branchname,IF(employee_raise_ticket.category_type='','',employee_raise_ticket.category_type) AS category_type,if(employee_raise_ticket.category_type='Urgent and Important','#db3623',if(employee_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(employee_raise_ticket.category_type='Not Urgent but Important','#d68233',if(employee_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `employee_raise_ticket` inner join branch_master on employee_raise_ticket.branch=branch_master.cost_center WHERE `realstatus`IN ('Pending by ED','Inprocessing by ED','Pending at ED') and employee_raise_ticket.`branch`=:branch and date(employee_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and employee_raise_ticket.category_type=:categoryORDER BY  employee_raise_ticket.created_on DESC");
		 ...
		 $revenue_list = $pdo -> prepare("SELECT employee_raise_ticket.`sno`, `type`, employee_raise_ticket.`ticket_id`,user_name, `category`, `issues`,if(employee_raise_ticket.`issues`='Any other Suggestions',employee_raise_ticket.`issue_details`,'') as issue_remarks, `issue_details`, `remarks`, `photo`, case when employee_raise_ticket.`status`='Pending' then concat(:baseurl,'appicons/pending.png') WHEN employee_raise_ticket.`status` like '%Rejected%' THEN concat(:baseurl,'appicons/rejected.png')  else concat(:baseurl,'appicons/accepted.png') end  as icon , CASE WHEN employee_raise_ticket.`status`='Pending' THEN '#F1732E' WHEN employee_raise_ticket.`status` like '%Rejected%' THEN '#fc033d' ELSE '#419505' END AS color ,employee_raise_ticket.`created_by`, date_format(employee_raise_ticket.`created_on`,'%d-%b-%Y %h:%i %p') as created_on , employee_raise_ticket.`modified_by`, employee_raise_ticket.`modified_on`, if(`photo`='Please select an image file to upload.' OR `photo`='Yes' or `photo`='Invalid image file'  or `photo`='','',concat(:baseurl,`photo`)) as image ,employee_raise_ticket.status ,assigned_person,`realstatus` ,employee_raise_ticket.branch,branch_master.display_name as branchname,IF(employee_raise_ticket.category_type='','',employee_raise_ticket.category_type) AS category_type,if(employee_raise_ticket.category_type='Urgent and Important','#db3623',if(employee_raise_ticket.category_type='Not Urgent and Not Important','#66bde8',if(employee_raise_ticket.category_type='Not Urgent but Important','#d68233',if(employee_raise_ticket.category_type='Urgent but Not Important','#f0606e',''))))as category_colour FROM `employee_raise_ticket` inner join branch_master on employee_raise_ticket.branch=branch_master.cost_center WHERE (`realstatus` LIKE  '%Resolve%' or `realstatus` LIKE  '%Reject%') and employee_raise_ticket.`branch`=:branch and date(employee_raise_ticket.`created_on`) BETWEEN :fdate and :tdate and employee_raise_ticket.category_type=:category ORDER BY  employee_raise_ticket.created_on DESC");
