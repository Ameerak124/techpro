...
if($check->rowCount() > 0){
$query=$pdoread->prepare("SELECT $category AS catageory,DATE_FORMAT(`createdon`,'%d-%b-%Y') AS createdon,`consultant`as docname
FROM `ip_discharge_summary` WHERE   `umrno`=:umrno");
