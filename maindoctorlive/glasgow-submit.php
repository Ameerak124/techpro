...
$motor_response=trim($data->motor_response);
$verbal_response=trim($data->verbal_response);
$eye_opening=trim($data->eye_opening);
...
//insert query
$ninsert=$pdo4->prepare("INSERT IGNORE INTO `glasgow_score`(`sno`, `createdfrom`, `ipno`, `umrno`,  `motor_response`, `verbal_response`, `eye_opening`, `motor_response_score`, `verbal_response_score`, `eye_opening_score`, `score`,`estatus`, `createdon`, `createdby`, `modifiedon`, `modifiedby`, `cost_center`,`del_remarks`) VALUES (NULL,'Score Assessment',:ipno,:umrno,:motor_response, :verbal_response,:eye_opening, :motor_response_score,:verbal_response_score,:eye_opening_score,:score,'Active',CURRENT_TIMESTAMP,:userid,CURRENT_TIMESTAMP,:userid,:costcenter,'') ");
$ninsert->bindParam(':ipno', $ipno, PDO::PARAM_STR);
$ninsert->bindParam(':umrno', $umrno, PDO::PARAM_STR);
$ninsert->bindParam(':motor_response', $motor_response, PDO::PARAM_STR);
$ninsert->bindParam(':verbal_response', $verbal_response, PDO::PARAM_STR);
$ninsert->bindParam(':eye_opening', $eye_opening, PDO::PARAM_STR);
