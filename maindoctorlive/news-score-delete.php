...
$update=$pdo4->prepare("UPDATE `news_score` SET `estatus`='Inactive' , `modifiedby`=:userid , `modifiedon`=CURRENT_TIMESTAMP, `del_remarks`=:del_remarks WHERE `sno`=:sno AND `cost_center`=:cost_center");
