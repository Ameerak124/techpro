...
$lost=trim($data->lost);
$eating=trim($data->eating);  
$weights_score=trim($data->weights_score);
$lost_score=trim($data->lost_score);
$eating_score=trim($data->eating_score);  
...
//insert query
$ninsert=$pdo4->prepare("INSERT IGNORE INTO `malnutrition_score`(`sno`, `createdfrom`, `ipno`, `umrno`,  `weights`, `weights_score`, `lost`, `lost_score`, `eating`, `eating_score`,  `score`, `estatus`, `createdon`, `createdby`, `modifiedon`, `modifiedby`, `cost_center`, `del_remarks`) VALUES (NULL,'Score Assessment',:ipno,:umrno, :weights, :weights_score, :lost, :lost_score, :eating, :eating_score, :score, 'Active',CURRENT_TIMESTAMP,:userid,CURRENT_TIMESTAMP,:userid,:costcenter,'') ");
...
$ninsert->bindParam(':lost_score', $lost_score, PDO::PARAM_STR);
$ninsert->bindParam(':lost', $lost, PDO::PARAM_STR);
$ninsert->bindParam(':eating_score', $eating_score, PDO::PARAM_STR);
...
/*
	...
	$response['error'] = true;
	$response['messweights']= "Connection failed: " . $e->getMessweights();
}
*/
